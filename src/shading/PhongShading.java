...
public class PhongShading implements PixelShader{
    ...
    @Override
    public Color shade(Polygon polygon, Vertex3D vertex) {
        currentPixel = vertex;
        ...
        retColor = getNewColor(vertex);
        return retColor;
    }

    private Color getNewColor(Vertex3D vertex) {
